    ...
    <Html>
      ...
      <Body style={{ backgroundColor: "#FDFCF8", margin: 0, padding: 0 }}>
        <Container style={{ maxWidth: "560px", margin: "0 auto", padding: "40px 20px" }}>
          ...
          {/* Body */}
          <Text style={{ fontSize: "20px", fontWeight: 800, color: "#292524", margin: "0 0 8px" }}>
            {daysAgo} Days Ago, You Thought...
          </Text>

          <Text style={{ fontSize: "13px", fontWeight: 600, color: "#78716C", textTransform: "uppercase" as const, letterSpacing: "0.1em", margin: "0 0 16px" }}>
            {contentType} — {contentTitle}
          </Text>

          {/* Reflection blockquote */}
          <Section style={{ backgroundColor: "#E8EFE8", borderRadius: "16px", padding: "24px", margin: "0 0 24px", borderLeft: "4px solid #292524" }}>
            <Text style={{ fontSize: "15px", color: "#292524", lineHeight: "1.6", margin: 0, fontStyle: "italic" }}>
              &ldquo;{reflectionContent.length > 300 ? reflectionContent.slice(0, 300) + "..." : reflectionContent}&rdquo;
            </Text>
          </Section>
