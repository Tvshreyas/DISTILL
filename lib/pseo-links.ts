...
export const bookToPrompts: Record<string, string[]> = {
  ...
  "deep-work": ["self-improvement", "creativity"],
  "thinking-fast-and-slow": ["psychology", "economics"],
  sapiens: ["history", "science"],
  "the-psychology-of-money": ["economics", "psychology"],
  "mans-search-for-meaning": ["philosophy", "psychology"],
  meditations: ["philosophy", "spirituality"],
  "48-laws-of-power": ["leadership", "psychology"],
  "how-to-win-friends-and-influence-people": ["relationships", "leadership"],
  "the-alchemist": ["fiction", "spirituality"],
  educated: ["education", "self-improvement"],
  ...
  flow: ["psychology", "creativity"],
  mindset: ["psychology", "education"],
  grit: ["psychology", "self-improvement"],
  "the-power-of-habit": ["psychology", "self-improvement"],
  "never-split-the-difference": ["psychology", "business"],
  ...
  "rich-dad-poor-dad": ["economics", "self-improvement"],
  "think-and-grow-rich": ["self-improvement", "psychology"],
  "the-subtle-art-of-not-giving-a-fck": ["philosophy", "self-improvement"],
  ...
  "predictably-irrational": ["psychology", "economics"],
  nudge: ["psychology", "economics"],
  "thinking-in-bets": ["psychology", "business"],
  "the-black-swan": ["economics", "philosophy"],
  antifragile: ["philosophy", "economics"],
  ...
  "the-body-keeps-the-score": ["health", "psychology"],
  attached: ["relationships", "psychology"],
  "the-power-of-now": ["spirituality", "philosophy"],
  "shoe-dog": ["business", "self-improvement"],
};
