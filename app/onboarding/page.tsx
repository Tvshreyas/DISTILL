...
const STEPS = [
  {
    ...
    description:
      "a digital living room for your thoughts. intentionally slow, tactile, and private.",
    icon: Sparkles,
    accent: "bg-sage",
  },
  {
    ...
    title: "how it works",
    description:
      "reflect on what you consume—books, videos, articles. we use spaced repetition to resurface your insights at the perfect moment.",
    icon: Layout,
    accent: "bg-peach",
  },
  {
    ...
    title: "make it yours",
    description:
      "we'll sync with your local time to send subtle reminders when you're most receptive.",
    icon: Clock,
    accent: "bg-lavender",
  },
  {
    ...
    description:
      "you're ready. start your first reflection to anchor your journey.",
    icon: Zap,
    accent: "bg-sage",
  },
];
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="mt-8 space-y-8">
              <div
                className={`w-20 h-20 rounded-3xl ${step.accent} flex items-center justify-center brutal-border-sm border-2`}
              >
              ...
              <div className="space-y-4">
                ...
                {step.id === "welcome" && (
                  <p className="text-[10px] md:text-xs text-muted-text/60 italic font-medium leading-relaxed pt-2 border-t border-soft-black/5">
                    Disclaimer: Distill is a thinking development tool. It is
                    NOT a medical device and is NOT intended to diagnose, treat,
              ...
              {step.id === "setup" && (
                <div className="p-6 bg-lavender/30 rounded-2xl brutal-border-sm border-2 space-y-2">
                  <span className="text-xs uppercase font-bold tracking-widest text-soft-black/60">
                    Detected Location
                  </span>
              ...
              <div className="pt-8">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <span className="flex items-center gap-2">
                      enter distill <Sparkles className="w-6 h-6" />
                    </span>
                  ) : (
                    <span className="flex items-center gap-2">
