# Distill — Daily Carousel Content Plan

**Period:** March 14–24, 2026 (10 days pre-launch + launch day on March 24)
**Platforms:** LinkedIn + Instagram
**Format:** 5–6 slides per carousel, 1080×1350px (Instagram) / 1080×1080 or 1080×1350 (LinkedIn)
**Voice:** lowercase, no hype, contrarian, identity-framing. no emojis as pattern. periods at end of thoughts.
...
> bookmarks are links you'll never revisit.
...
> it doesn't use AI to think for you.
...
> or organizing it. or summarizing it.
>
...
>
> no AI summaries. no auto-generated notes.
...
> every lecture. every podcast. every article.
>
> input is solved.
...
> you close an article and open another tab.
...
>
> thinking is the only active part.
...
> you notice your thinking has changed.
>
> day 90: patterns emerge across reflections.
...
> year 1: 52 reflections.
>
> 52 pieces of original thought.
...
>
> you need one reflection.
> after one thing you consumed.
> once a week.
...
> the hard part is stopping long enough to think.
...
> write what you think. your reflections resurface.
...
> 2. read, watch, or listen (externally)
...
- Comment immediately with the distillwise.com link
...
- Add "link in bio" to every caption
- Use Stories to tease each carousel post
- Save carousels to a "launch" highlight

---

## Design Specs (for HTML templates)

- **Background:** #FDFCF8 (warm off-white)
- **Text:** #292524 (soft black)
- **Accent:** #FFB7B2 (peach) — for highlights, underlines, slide numbers
- **Secondary bg:** #E8EFE8 (sage) or #EFEDF4 (lavender) — alternate slides
- **Border:** 3px solid #292524
- **Shadow:** 6px 6px 0px #292524
- **Heading font:** Space Grotesk (bold/black, lowercase)
- **Body font:** Outfit (medium, lowercase)
- **Logo:** "distill." in Space Grotesk bold, bottom-right of every slide
- **Slide number:** small, top-left, peach background pill
