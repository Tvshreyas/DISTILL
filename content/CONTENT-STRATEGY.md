...
- Are knowledge workers, students, or lifelong learners

**Voice:** Direct, lowercase-leaning, anti-hype. No praise language. No marketing fluff. Factual and thought-provoking. Think "Cal Newport meets brutalist zine."
...
## Editorial Calendar — Next 8 Posts (Priority Order)
...
- Angle: Most articles list generic tips. Ours introduces the "reflection loop" concept — the idea that writing your own perspective after reading is the highest-leverage retention technique. Positions Distill naturally.
- CTA: Soft — "Distill automates this reflection loop. Try it free."
- Internal links TO: Slow Thinking, Paradox of Digital Information
- Internal links FROM: Update existing posts to link here
- H2 outline:
...
- Angle: Explains Ebbinghaus forgetting curve, passive vs. active processing. Positions reflection as the bridge between consuming and retaining.
- Internal links TO: "How to Remember" post, Slow Thinking
- H2 outline:
  ...
  - The Reflection Gap: The 5 Minutes Most Readers Skip
...
- Angle: Not another "put your phone in a drawer" article. Reframes the problem: doomscrolling isn't about willpower, it's about not having a better alternative. Introduces "distillation sessions" as a replacement habit.
- Internal links TO: Information Diet, Paradox of Digital Information
- H2 outline:
  - Doomscrolling Is Not a Willpower Problem
  - What Your Brain Is Actually Looking For (novelty, not value)
...
- H2 outline:
  ...
  - Step 2: Cut the Empty Calories (content that adds no perspective)
  - Step 3: Schedule Deep Reading Blocks
  - Step 4: Process What You Consume (the reflection step)
...
- Intent: Informational
- Word count: 1,500-1,800
- Angle: Most spaced repetition content targets language learners or med students. This targets general readers. Positions Distill's "spaced resurfacing" as the reader's version.
...
- Intent: Informational
- Word count: 1,800-2,200
- Angle: Differentiate from journaling. Reflection is content-triggered, not emotion-triggered. This is Distill's core value prop as a blog post.
...
Landing Page (/)
  └── /blog (hub)
        ├── how-to-remember-what-you-read (Pillar 1 hub)
        │     ├── why-you-forget-everything-you-read
        │     ├── active-reading-techniques
        │     ├── spaced-repetition-for-readers
        │     └── writing-to-think
        ├── information-diet (Pillar 2 hub)
        │     ├── how-to-stop-doomscrolling
        │     ├── the-paradox-of-digital-information (existing)
        │     └── mindful-content-consumption (future)
        ├── reflection-habit (Pillar 3 entry)
        │     ├── the-art-of-slow-thinking (existing)
        │     ├── compound-thinking (future)
        │     └── personal-knowledge-library (future)
        └── distillation-competitive-advantage-2026 (existing, Pillar 4)
              └── think-for-yourself-ai (future)
```
...
- No medical/wellness claims
- Factual, evidence-based claims with sources
...
5. Verify JSON-LD renders (BlogPosting schema auto-generated)
...
- Time on page / scroll depth (PostHog)
- Conversion: clicks to `/start` or `/sign-up` from blog
...
1. Write Post 4: "How to Remember What You Read" (highest volume keyword)
2. Write Post 5: "Why You Forget Everything You Read"
3. Write Post 6: "How to Stop Doomscrolling"
4. After publishing Wave 1 → update existing 3 posts with internal links to new posts
5. Submit all new URLs to Google Search Console
6. Write Wave 2 posts (7-11) over next 2-4 weeks
