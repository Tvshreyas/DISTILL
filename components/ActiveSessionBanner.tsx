  ...
  return (
    <div className="p-4 rounded-2xl border-2 border-soft-black bg-peach/10 flex items-center justify-between">
      <div className="flex flex-col">
        <span className="text-xs uppercase tracking-widest text-muted-text font-bold">Active Session</span>
        <span className="text-sm font-medium text-soft-black">{session.title}</span>
      </div>
      <Link
